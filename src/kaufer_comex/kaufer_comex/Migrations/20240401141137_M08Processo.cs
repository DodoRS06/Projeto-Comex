        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgenteDeCargaId = table.Column<int>(type: "int", nullable: true),
                    FronteiraId = table.Column<int>(type: "int", nullable: true),
                    DespachanteId = table.Column<int>(type: "int", nullable: true),
                    VendedorId = table.Column<int>(type: "int", nullable: true),
                    StatusId = table.Column<int>(type: "int", nullable: true),
                    Proforma = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DataInicioProcesso = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PrevisaoProducao = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PrevisaoPagamento = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PrevisaoColeta = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PrevisaoCruze = table.Column<DateTime>(type: "datetime2", nullable: true),
