        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseNota = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ValorFob = table.Column<float>(type: "real", nullable: true),
                    ValorFrete = table.Column<float>(type: "real", nullable: true),
                    ValorSeguro = table.Column<float>(type: "real", nullable: true),
                    ValorCif = table.Column<float>(type: "real", nullable: true),
                    PesoLiq = table.Column<float>(type: "real", nullable: true),
                    PesoBruto = table.Column<float>(type: "real", nullable: true),
                    TaxaCambial = table.Column<float>(type: "real", nullable: true),
