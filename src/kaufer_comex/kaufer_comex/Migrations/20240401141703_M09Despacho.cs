        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataExportacao = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ConhecimentoEmbarque = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DataConhecimento = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Tipo = table.Column<int>(type: "int", nullable: true),
                    DataAverbacao = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CodPais = table.Column<int>(type: "int", nullable: true),
                    Parametrizacao = table.Column<int>(type: "int", nullable: true),
